...
public class QuizActivity extends AppCompatActivity {
    ...
    // total number of question in arraylist;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewScore = findViewById(R.id.test_view_score);
    ...
    private void showSolution(){
        ...
        switch (currentQuestion.getAnswerNr()){
            case 1:
                ...
                textViewQuestions.setText("Answer 1 is correect");
                break;
            case 2:
                rb2.setTextColor(Color.GREEN);
                textViewQuestions.setText("Answer 2 is correect");
                break;
            case 3:
                rb3.setTextColor(Color.GREEN);
                textViewQuestions.setText("Answer 3 is correect");
                break;
        }
        if(questionCounter<questionCountTotal){
